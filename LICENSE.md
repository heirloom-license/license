...
**Example:** `HL-1.0-MPL2.0-12mo`

> **Draft status.** This is a community draft (v1.0-draft). It has not yet
> been reviewed by a licensing attorney in your jurisdiction. Have counsel
> review the **Dormancy Trigger** and **Disclaimer of Warranty** sections
> before relying on it commercially. See `LEGAL-REVIEW.md`.

---

## Parameters

The Licensor must fill in every parameter below before publishing software
under this license. The filled-in values, together with this text, form the
complete license.

| Parameter | Meaning | This work's value |
|---|---|---|
| **Licensor** | The copyright holder granting this license | `__________________` |
| **Licensed Work** | The software covered by this license, including its version | `__________________` |
| **Change License** | The open-source license the Licensed Work converts to on Sunset. Must be an OSI-approved copyleft license (e.g. MPL-2.0, GPL-3.0-or-later, AGPL-3.0-or-later). Recommended default: **MPL-2.0**. | `__________________` |
| **Dormancy Window** | The continuous period of Dormancy that triggers Sunset. Recommended default: **12 months**. | `__________________` |
| **Source Repository** | The canonical URL where the Source Form is or will be published on Sunset | `__________________` |
| **Heartbeat Record** | The public, timestamped location where the Licensor records continued maintenance (see Section 4) | `__________________` |
...
project>`. This license text is itself dedicated to the public domain under
CC0 1.0 — you may copy, adopt, and modify it without restriction. "Heirloom
License" and the Heirloom badge are project marks; use them only to describe
software actually released under an unmodified version of this license.*
